...
var blocOneTrials = [[1, 5, 0, 1], [1, 6, 0, 1], [1, 7, 0, 1], [1, 8, 0, 1], [2, 5, 0, 1], [2, 6, 0, 1], [2, 7, 0, 1],
    [2, 8, 0, 1], [3, 5, 0, 1], [3, 6, 0, 1], [3, 7, 0, 1], [3, 8, 0, 1], [4, 5, 0, 1], [4, 6, 0, 1], [4, 7, 0, 1],
    [4, 8, 0, 1], [5, 1, 0, 1], [5, 2, 0, 1], [5, 3, 0, 1], [5, 4, 0, 1], [6, 1, 0, 1], [6, 2, 0, 1], [6, 3, 0, 1],
    [6, 4, 0, 1], [7, 1, 0, 1], [7, 2, 0, 1], [7, 3, 0, 1], [7, 4, 0, 1], [8, 1, 0, 1], [8, 2, 0, 1], [8, 3, 0, 1],
    [8, 4, 0, 1], [1, 5, 1, 1], [1, 6, 1, 1], [1, 7, 1, 1], [1, 8, 1, 1], [2, 5, 1, 1], [2, 6, 1, 1], [2, 7, 1, 1],
    [2, 8, 1, 1], [3, 5, 1, 1], [3, 6, 1, 1], [3, 7, 1, 1], [3, 8, 1, 1], [4, 5, 1, 1], [4, 6, 1, 1], [4, 7, 1, 1],
    [4, 8, 1, 1], [5, 1, 1, 1], [5, 2, 1, 1], [5, 3, 1, 1], [5, 4, 1, 1], [6, 1, 1, 1], [6, 2, 1, 1], [6, 3, 1, 1],
    [6, 4, 1, 1], [7, 1, 1, 1], [7, 2, 1, 1], [7, 3, 1, 1], [7, 4, 1, 1], [8, 1, 1, 1], [8, 2, 1, 1], [8, 3, 1, 1],
    [8, 4, 1, 1]];
// blocOneTrials = [[1, 5, 0, 1], [2, 6, 1, 1]];
var blocTwoTrials = [[1, 5, 0, 2], [1, 6, 0, 2], [1, 7, 0, 2], [1, 8, 0, 2], [2, 5, 0, 2], [2, 6, 0, 2], [2, 7, 0, 2],
    [2, 8, 0, 2], [3, 5, 0, 2], [3, 6, 0, 2], [3, 7, 0, 2], [3, 8, 0, 2], [4, 5, 0, 2], [4, 6, 0, 2], [4, 7, 0, 2],
    [4, 8, 0, 2], [5, 1, 0, 2], [5, 2, 0, 2], [5, 3, 0, 2], [5, 4, 0, 2], [6, 1, 0, 2], [6, 2, 0, 2], [6, 3, 0, 2],
    [6, 4, 0, 2], [7, 1, 0, 2], [7, 2, 0, 2], [7, 3, 0, 2], [7, 4, 0, 2], [8, 1, 0, 2], [8, 2, 0, 2], [8, 3, 0, 2],
    [8, 4, 0, 2], [1, 5, 1, 2], [1, 6, 1, 2], [1, 7, 1, 2], [1, 8, 1, 2], [2, 5, 1, 2], [2, 6, 1, 2], [2, 7, 1, 2],
    [2, 8, 1, 2], [3, 5, 1, 2], [3, 6, 1, 2], [3, 7, 1, 2], [3, 8, 1, 2], [4, 5, 1, 2], [4, 6, 1, 2], [4, 7, 1, 2],
    [4, 8, 1, 2], [5, 1, 1, 2], [5, 2, 1, 2], [5, 3, 1, 2], [5, 4, 1, 2], [6, 1, 1, 2], [6, 2, 1, 2], [6, 3, 1, 2],
    [6, 4, 1, 2], [7, 1, 1, 2], [7, 2, 1, 2], [7, 3, 1, 2], [7, 4, 1, 2], [8, 1, 1, 2], [8, 2, 1, 2], [8, 3, 1, 2],
    [8, 4, 1, 2]];
var activeTrial = [];
...
$(document).ready(function () {
    ...
    function stopTracking(event, beginBlock2) {
        if (event.target.id == 'left') {
            bugout.log(activeTrial + ',1');
            // console.log("Stimuli= " + activeTrial + ',1');
        }
        else {
